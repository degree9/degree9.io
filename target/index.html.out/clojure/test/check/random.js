...
var x__8656__auto__ = (((rng == null))?null:rng);
var m__8657__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__8656__auto__)]);
if(!((m__8657__auto__ == null))){
return m__8657__auto__.call(null,rng);
} else {
var m__8657__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__8657__auto____$1 == null))){
return m__8657__auto____$1.call(null,rng);
} else {
...
var x__8656__auto__ = (((rng == null))?null:rng);
var m__8657__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__8656__auto__)]);
if(!((m__8657__auto__ == null))){
return m__8657__auto__.call(null,rng);
} else {
var m__8657__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__8657__auto____$1 == null))){
return m__8657__auto____$1.call(null,rng);
} else {
...
var x__8656__auto__ = (((rng == null))?null:rng);
var m__8657__auto__ = (clojure.test.check.random.split[goog.typeOf(x__8656__auto__)]);
if(!((m__8657__auto__ == null))){
return m__8657__auto__.call(null,rng);
} else {
var m__8657__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__8657__auto____$1 == null))){
return m__8657__auto____$1.call(null,rng);
} else {
...
var x__8656__auto__ = (((rng == null))?null:rng);
var m__8657__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__8656__auto__)]);
if(!((m__8657__auto__ == null))){
return m__8657__auto__.call(null,rng,n);
} else {
var m__8657__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__8657__auto____$1 == null))){
return m__8657__auto____$1.call(null,rng,n);
} else {
...
return clojure.test.check.random.longs.bit_xor.call(null,G__9269,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__9269;
}
});
...
var G__9272 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__9273 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__9272;
ret = G__9273;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__8595__auto__,writer__8596__auto__,opt__8597__auto__){
return cljs.core._write.call(null,writer__8596__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__7938__auto__ = clojure.test.check.random.longs.__GT_long.call(null,seed);
...
var state = cljs.core.get.call(null,map__9275__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__9277 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__9277,(0),null);
var r2 = cljs.core.nth.call(null,vec__9277,(1),null);
...
var args9280 = [];
var len__9159__auto___9283 = arguments.length;
var i__9160__auto___9284 = (0);
while(true){
if((i__9160__auto___9284 < len__9159__auto___9283)){
args9280.push((arguments[i__9160__auto___9284]));

var G__9285 = (i__9160__auto___9284 + (1));
i__9160__auto___9284 = G__9285;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args9280.length)].join('')));
